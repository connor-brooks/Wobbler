...
main: maximilian.o synth.o control.o voice.o gui_container.o utils.o init.o keyboard.o midi.o console.o main.o 
	g++ -std=c++11 maximilian.o synth.o control.o voice.o gui_container.o utils.o init.o keyboard.o midi.o console.o main.o -o wob -I /usr/local/Cellar/sdl2/2.0.10/include -L /usr/local/Cellar/sdl2/2.0.10/lib -l SDL2-2.0.0 -lrtmidi -framework OpenGL
